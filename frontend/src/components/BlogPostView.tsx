            ...
            <article className="max-w-4xl mx-auto px-4 pt-8 pb-20">
                ...
                <div className="rounded-2xl overflow-hidden mb-12 border border-zinc-100">
                    <img
                        ...
                        onError={(e) => { const t = e.currentTarget; t.style.display = 'none'; t.parentElement!.classList.add('bg-gradient-to-br', 'from-zinc-100', 'to-zinc-200', 'flex', 'items-center', 'justify-center', 'aspect-[21/9]'); t.parentElement!.innerHTML = '<svg class="w-12 h-12 text-zinc-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>'; }}
                    />
                </div>
                                ...
                                >
                                    <div className="aspect-[16/10] overflow-hidden">
                                        <img
                                            ...
                                            loading="lazy"
                                            onError={(e) => { const t = e.currentTarget; t.style.display = 'none'; t.parentElement!.classList.add('bg-gradient-to-br', 'from-zinc-100', 'to-zinc-200', 'flex', 'items-center', 'justify-center'); t.parentElement!.innerHTML = '<svg class="w-8 h-8 text-zinc-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>'; }}
                                        />
                                    </div>
                                    <div className="p-4">
