            ...
            <div className="relative">
              <div className="relative aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl">
                <img
                  ...
                  onError={(e) => { const t = e.currentTarget; t.onerror = null; t.style.display = 'none'; t.parentElement!.classList.add('bg-gradient-to-br', 'from-zinc-200', 'to-zinc-300', 'flex', 'items-center', 'justify-center'); t.parentElement!.innerHTML = '<svg class="w-16 h-16 text-zinc-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>'; }}
                />
